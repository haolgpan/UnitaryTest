...
class HashTableTest {
    ...
    @org.junit.jupiter.api.Test
    void put_object_empty(){
        HashTable ht = new HashTable();
        ht.put("Test",123);
        Assertions.assertEquals("\n" +
                " bucket[2] = [Test, 123]",ht.toString());
        Assertions.assertEquals(16,ht.size());
        Assertions.assertEquals(1,ht.count());
    }
    @org.junit.jupiter.api.Test
    void put_object_no_empty(){
        HashTable ht = new HashTable();
        ht.put("patat",true);
        ht.put("Test","tost");
        ht.put("2",0.45f);
        ht.put("02",'a');
        Assertions.assertEquals("\n" +
                " bucket[2] = [Test, tost] -> [2, 0.45] -> [02, a]\n" +
                " bucket[6] = [patat, true]",ht.toString());
        Assertions.assertEquals(16,ht.size());
    ...
    void put_update(){
        ...
        ht.put("Test",true);
        Assertions.assertEquals("\n" +
                " bucket[2] = [Test, true]",ht.toString());
        Assertions.assertEquals(16,ht.size());
        Assertions.assertEquals(1,ht.count());
    }
    @org.junit.jupiter.api.Test
    void put_update_colision(){
        HashTable ht = new HashTable();
        ht.put("Test",123);
        ht.put("2",false);
        ht.put("02",4.56f);
        ht.put("Test","testing");
        Assertions.assertEquals("\n" +
                " bucket[2] = [Test, testing] -> [2, false] -> [02, 4.56]",ht.toString());
        Assertions.assertEquals(16,ht.size());
        Assertions.assertEquals(3,ht.count());
    }
    @org.junit.jupiter.api.Test
    void get_single_object(){
        HashTable ht = new HashTable();
        ht.put("Test",123);
        Assertions.assertEquals(123,ht.get("Test"));
        Assertions.assertEquals(null,ht.get("2"));
        Assertions.assertEquals(null,ht.get("patat"));
        Assertions.assertEquals(16,ht.size());
        Assertions.assertEquals(1,ht.count());
    }
    @org.junit.jupiter.api.Test
    void get_object_no_empty(){
        HashTable ht = new HashTable();
        ht.put("patat",true);
        ht.put("Test","tost");
        ht.put("2",0.45f);
        ht.put("02",'a');
        Assertions.assertEquals(true,ht.get("patat"));
        Assertions.assertEquals("tost",ht.get("Test"));
        Assertions.assertEquals(0.45f,ht.get("2"));
        Assertions.assertEquals('a',ht.get("02"));
        Assertions.assertEquals(16,ht.size());
        Assertions.assertEquals(4,ht.count());
    }
    @org.junit.jupiter.api.Test
    void drop_single_object(){
        HashTable ht = new HashTable();
        ht.put("Test",123);
        ht.drop("Test");
        Assertions.assertEquals(null,ht.get("Test"));
        Assertions.assertEquals(null,ht.get("2"));
        Assertions.assertEquals(null,ht.get("patat"));
        Assertions.assertEquals(16,ht.size());
        Assertions.assertEquals(0,ht.count());
    ...
    void drop_object_no_empty(){
        ...
        Assertions.assertEquals(2,ht.count());
        Assertions.assertEquals("\n" +
                " bucket[2] = [2, 0.45] -> [02, a]",ht.toString());
    }
