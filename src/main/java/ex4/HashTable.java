...
//            hashEntry.prev = temp;
            ...
            if (updateEntry(key, value, hash)) return;
            HashEntry temp;
...
//        }
    ...
    public String toString() {
        ...
        for (HashEntry entry : entries) {
            ...
            bucket = append(bucket, hashTableStr, entry);
        }
        return hashTableStr.toString();
    }

    private static int append(int bucket, StringBuilder hashTableStr, HashEntry entry) {
        hashTableStr.append("\n bucket[")
                .append(bucket)
                .append("] = ")
